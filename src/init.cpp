    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("zzcoin version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  zzcoind [options]                     " + "\n" +
                  "  zzcoind [options] <command> [params]  " + _("Send command to -server or zzcoind") + "\n" +
                  "  zzcoind [options] help                " + _("List commands") + "\n" +
                  "  zzcoind [options] help <command>      " + _("Get help for a command") + "\n";
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -pid=<file>            " + _("Specify pid file (default: zzcoind.pid)") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 10504 or testnet: 10604)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 10503 or testnet: 10603)") + "\n" +
        ...
        "\n" + _("SSL options: (see the zzcoin Wiki for SSL setup instructions)") + "\n" +
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (!lock.try_lock())
        return InitError(strprintf(_("Cannot obtain a lock on data directory %s. zzcoin is probably already running."), strDataDir.c_str()));
